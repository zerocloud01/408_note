...
![](./img/Chap-1/时延计算1.png)
![](./img/Chap-1/时延计算2.png)

对于发送 $m$ 个分组，经过 $n$ 个路由器转发：
$总时延 = 1个分组发送时延 \times (m+1) + 1段链路传播时延 \times (n+1)$
...
### 数据包按网络体系结构逐层封装和解封
![](./img/Chap-1/数据包封装与解封.png)

![](./img/Chap-1/网络参考模型细化图.png)
